  ...
  const handleSubmit = async (recipeType) => {
    ...
    try {
      ...
      const json_example = {
        ...
        ingredients: [ "amount(INSERT INTEGER AMOUNT OF INGREDIENT), id, name(INSERT JUST THE INGREDIENT NAME), unit(INSERT UNIT OF MEASUREMENT FOR AMOUNT), isSaved(True or False)"
        ],
